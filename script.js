...
// ============================================================
// 9. FLOATING CARD — subtle mouse parallax on hero section
// ============================================================
...
if (codeCard) {
  document.addEventListener('mousemove', (e) => {
    ...
    // Subtle parallax — max ±10px shift
    const moveX = deltaX * 10;
    const moveY = deltaY * 8;
    codeCard.style.transform = `translateY(calc(-50% + ${moveY}px)) translateX(${moveX}px)`;
  });
}

// ============================================================
// 10. CONSOLE EASTER EGG — for curious devs who open DevTools
// ============================================================
